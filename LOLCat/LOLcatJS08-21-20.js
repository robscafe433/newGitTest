// I was practicing eventListeners. A bug that I could not figure out was line 16, where the image was not changing, so that is reason i added the alerts to actually see if the if statements were working. Originally I wrote line 16 as "lolcatImageJS.innerText =" and "lolcatImageJS.innerHTML =" but eventually figured I had to use the ".src" as images are not treated the same as texts. //
